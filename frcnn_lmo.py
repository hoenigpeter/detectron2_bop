...
if __name__ == "__main__":
    ...
    register_coco_instances("lmo_pbr_meta", {}, "./datasets/BOP_DATASETS/lmo/train_pbr/000000/scene_gt_coco.json", "./datasets/BOP_DATASETS/lmo/train_pbr/000000")
    ...
    def bop_scenes_to_coco():
        ...
        for id in scene_ids:
            scene_list.extend(load_coco_json("./datasets/BOP_DATASETS/lmo/train_pbr/{:06d}/scene_gt_coco.json".format(id), "./datasets/BOP_DATASETS/lmo/train_pbr/{:06d}".format(id), "lmo_pbr_meta", None))
        
        return scene_list

    DatasetCatalog.register("lmo_pbr_train", bop_scenes_to_coco)

    print("dataset catalog: ", DatasetCatalog.list())
    dataset_temp = DatasetCatalog.get("lmo_pbr_train")
    print(MetadataCatalog.get("lmo_pbr_train"))
