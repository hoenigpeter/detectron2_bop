...
if __name__ == "__main__":
    register_coco_instances("itodd_random_texture_pbr_train", {}, "datasets/itodd_random_texture/itodd_random_texture_annotations_train.json", "datasets/itodd_random_texture/train_pbr")
