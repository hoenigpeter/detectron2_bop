...
if __name__ == "__main__":
    ...
    register_coco_instances("itodd_random_texture_pbr_meta", {}, "./datasets/BOP_DATASETS/itodd_random_texture/train_pbr/000000/scene_gt_coco.json", "./datasets/BOP_DATASETS/itodd_random_texture/train_pbr/000000")
    ...
    def bop_scenes_to_coco():
        ...
        for id in scene_ids:
            scene_list.extend(load_coco_json("./datasets/BOP_DATASETS/itodd_random_texture/train_pbr/{:06d}/scene_gt_coco.json".format(id), "./datasets/BOP_DATASETS/itodd_random_texture/train_pbr/{:06d}".format(id), "itodd_random_texture_pbr_meta", None))
        
        return scene_list

    DatasetCatalog.register("itodd_random_texture_pbr_train", bop_scenes_to_coco)

    print("dataset catalog: ", DatasetCatalog.list())
    dataset_temp = DatasetCatalog.get("itodd_random_texture_pbr_train")
    print(MetadataCatalog.get("itodd_random_texture_pbr_train"))

    # Create a Detectron2 config
    # Add a directory to save the model checkpoints
    output_dir = "./frcnn_itodd_random_texture_model"
    ...
    cfg.DATASETS.TRAIN = ("itodd_random_texture_pbr_train",)
    cfg.DATASETS.TEST = ()
