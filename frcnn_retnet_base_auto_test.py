...
def save_results_to_csv(output_dir, model_name, metrics):
    csv_file = output_dir + "/evaluation_results.csv"

    with open(csv_file, mode='a') as file:
        writer = csv.writer(file)
        writer.writerow([model_name, metrics["bbox"]["AP"]])
...
def main(args):
    ...
    if args.mode == "eval":
        ...
        save_results_to_csv(output_dir, args.model_name, metrics)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="model_final.pth", help="Name of model to use")
